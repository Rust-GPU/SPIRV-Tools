...
- [ ] Extend capability/extension ordering and remaining decoration constraints in layout to mirror the C++ tables.
  ...
  - Added capability/extension version gates for physical storage buffers and storage-buffer/variable-pointer extensions; continue importing remaining extension/capability version and ordering tables (e.g., shader clock, maximal reconvergence, untyped pointers).
