...
- Added C++ parity coverage for bitwise absorption (`x & (x | y)` and `x | (x & y)`) plus a 64-bit variant to guard the new bitwise rewrites against drift and width handling.
