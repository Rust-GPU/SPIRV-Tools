...
- [x] Translate a subset of SPIR-V arithmetic (OpConstant/OpIAdd/OpIMul) into e-graph expressions and collapse reducible blocks back to constants with round-trip tests.
