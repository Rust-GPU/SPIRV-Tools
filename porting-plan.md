...
- Add CLI exit-code/stdout/stderr/help parity harnesses for `spirv-reduce`, `spirv-fuzz`, `spirv-cfg`, and `spirv-lint` (mirror the help/version/error cases already covered for as/dis/val/opt; skip cleanly when C++ binaries are absent).
