...
- [x] Translate a subset of SPIR-V arithmetic (OpConstant/OpIAdd/OpIMul) into e-graph expressions with round-trip tests to keep rewrites aligned with real IR.
