...
fn module_with_extension_custom(extension: &str, capability: &str, memory_model: &str) -> String {
    [
        capability,
        &format!("OpExtension \"{extension}\""),
        memory_model,
...
/// Tests that valid floating-point arithmetic passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid floating-point vector arithmetic passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid integer arithmetic passes validation.
#[test]
...
/// Tests that valid integer multiplication passes validation.
#[test]
...
/// Tests that valid dot product passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid shift operations pass validation.
/// Uses binary construction since assembler doesn't support all bitwise opcodes.
#[test]
...
/// Tests that valid bitwise AND passes validation.
/// Uses binary construction since assembler doesn't support all bitwise opcodes.
#[test]
...
/// Tests that valid bitwise OR passes validation.
/// Uses binary construction since assembler doesn't support all bitwise opcodes.
#[test]
fn bitwise_valid_or() {
    use rspirv::binary::Assemble;
...
/// Tests that valid bitwise NOT passes validation.
/// Uses binary construction since assembler doesn't support all bitwise opcodes.
#[test]
...
/// Tests that valid vector bitwise operations pass validation.
/// Uses binary construction since assembler doesn't support all bitwise opcodes.
#[test]
...
/// Tests that valid float-to-int conversion passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid float-to-unsigned conversion passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid int-to-float conversion passes validation.
/// Uses binary construction since assembler doesn't support all conversion opcodes.
#[test]
...
/// Tests that valid vector conversion passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid logical AND passes validation.
/// Uses binary construction since assembler doesn't support all logical opcodes.
#[test]
...
/// Tests that valid logical OR passes validation.
/// Uses binary construction since assembler doesn't support all logical opcodes.
#[test]
fn logical_valid_or() {
    use rspirv::binary::Assemble;
...
/// Tests that valid logical NOT passes validation.
/// Uses binary construction since assembler doesn't support all logical opcodes.
#[test]
...
/// Tests that valid float comparison passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid integer comparison passes validation.
/// Uses binary construction since assembler doesn't support comparison opcodes.
#[test]
...
/// Tests that valid scalar float comparison passes validation.
/// Uses binary construction since assembler doesn't support float literals.
/// Note: Vector comparisons are skipped due to a pre-existing bug in the
/// validator's type lookup for vector element types.
#[test]
...
/// Tests that valid vector shuffle passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid composite extract passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid composite insert passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid composite construct passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid matrix transpose passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
/// Tests that valid copy object passes validation.
/// Uses binary construction since assembler doesn't support float literals.
#[test]
...
// ============================================================================
// Type Extension Trait Tests (unit tests in type_ext.rs)
// ============================================================================
