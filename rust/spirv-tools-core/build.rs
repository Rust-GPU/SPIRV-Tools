...
",
    ...
    for inst in &grammar.instructions {
        let (stage, is_capability, is_extension) = match inst.opname.as_str() {
            "OpCapability" => (Some("Capabilities"), true, false),
            "OpConditionalCapabilityINTEL" => (Some("Capabilities"), true, false),
            "OpExtension" => (Some("Extensions"), false, true),
            "OpConditionalExtensionINTEL" => (Some("Extensions"), false, true),
            "OpExtInstImport" => (Some("ExtInstImport"), false, false),
            "OpMemoryModel" => (Some("MemoryModel"), false, false),
            "OpEntryPoint" => (Some("EntryPoint"), false, false),
            "OpConditionalEntryPointINTEL" => (Some("EntryPoint"), false, false),
            "OpExecutionMode" => (Some("ExecutionMode"), false, false),
        ...
        if is_capability {
            capability_op_match_arms.push_str(&format!("        spirv::Op::{variant} => true,\n"));
        }
        if is_extension {
            extension_op_match_arms.push_str(&format!("        spirv::Op::{variant} => true,\n"));
        }
    }
