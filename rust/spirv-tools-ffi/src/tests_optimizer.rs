...
mod optimizer_tests {
    ...
    #[test]
    fn optimizer_folds_bitand_complement_u32() {
        let _guard = OptimizerEnvGuard::new();
    ...
    #[test]
    fn optimizer_folds_band_all_ones_u32() {
        let _guard = OptimizerEnvGuard::new();
    ...
    #[test]
    fn optimizer_folds_bor_zero_u32() {
        let _guard = OptimizerEnvGuard::new();
    ...
    #[test]
    fn optimizer_folds_bxor_self_u32() {
        let _guard = OptimizerEnvGuard::new();
        ...
        let _func = b
            ...
            .unwrap();
        let _ = b.begin_block(None).unwrap();
        let value = b.constant_bit32(int, 0x0BAD_F00D);
        let bxor = b.bitwise_xor(int, None, value, value).expect("bxor self");
        b.ret().unwrap();
        b.end_function().unwrap();
        let words = b.module().assemble();
    ...
    fn build_factored_mixed_const_wrap_positive_difference_unsigned_mul_module(
    ) -> (Vec<u32>, u32, u32) {
        let mut b = Builder::new();
        let void = b.type_void();
        let int = b.type_int(32, 0);
    ...
    fn build_factored_mixed_const_wrap_negative_difference_unsigned_mul_module(
    ) -> (Vec<u32>, u32, u32) {
        let mut b = Builder::new();
        let void = b.type_void();
        let int = b.type_int(32, 0);
