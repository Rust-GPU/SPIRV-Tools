...
pub fn rewrites() -> Vec<Rewrite<SpirvLang, ()>> {
    vec![
        ...
        rewrite!(
            "bor-shl-factor";
            "(bor (shl ?x ?c) (shl ?y ?c))" => "(shl (bor ?x ?y) ?c)"
        ),
        rewrite!(
            "bxor-shl-factor";
            "(bxor (shl ?x ?c) (shl ?y ?c))" => "(shl (bxor ?x ?y) ?c)"
        ),
        rewrite!(
            "band-shru-factor";
            "(band (shr_u ?x ?c) (shr_u ?y ?c))" => "(shr_u (band ?x ?y) ?c)"
        ),
        rewrite!(
            "bor-shru-factor";
            "(bor (shr_u ?x ?c) (shr_u ?y ?c))" => "(shr_u (bor ?x ?y) ?c)"
        ),
        rewrite!(
            "bxor-shru-factor";
        ...
        rewrite!(
            "bor-shrs-factor";
            "(bor (shr_s ?x ?c) (shr_s ?y ?c))" => "(shr_s (bor ?x ?y) ?c)"
        ),
        rewrite!(
            "bxor-shrs-factor";
        ...
        rewrite!("band-complement-nested-right"; "(band (bnot ?x) (band ?x ?y))" => {
        ...
        rewrite!("band-not-or-bnot-right"; "(band (bnot ?x) (bnot (bor ?x ?y)))" => "(bnot (bor ?x ?y))"),
        rewrite!("band-not-or-bnot-left"; "(band (bnot (bor ?x ?y)) (bnot ?x))" => "(bnot (bor ?x ?y))"),
        ...
        rewrite!("band-nested-idempotent-right"; "(band ?x (band ?x ?y))" => "(band ?x ?y)"),
        rewrite!("band-nested-idempotent-left"; "(band (band ?x ?y) ?x)" => "(band ?x ?y)"),
        rewrite!("band-nested-idempotent-swap-right"; "(band ?x (band ?y ?x))" => "(band ?x ?y)"),
        ...
        rewrite!(
            "band-absorb-nested-or-left";
            "(band (bor ?y (band ?x ?z)) ?x)" => "(band ?x (bor ?y ?z))"
        ),
        rewrite!(
            "band-absorb-nested-complement-or";
            "(band ?x (bor ?y (band (bnot ?x) ?z)))" => "(band ?x ?y)"
        ),
        rewrite!(
            "band-absorb-nested-complement-or-comm";
            "(band ?x (bor ?y (band ?z (bnot ?x))))" => "(band ?x ?y)"
        ),
        rewrite!(
            "band-absorb-nested-complement-or-invert";
            "(band (bnot ?x) (bor ?y (band ?x ?z)))" => "(band (bnot ?x) ?y)"
        ),
        ...
        rewrite!("band-or-notor-to-xor-right"; "(band (bor ?x ?y) (bor (bnot ?x) (bnot ?y)))" => "(bxor ?x ?y)"),
        rewrite!("band-or-notor-to-xor-left"; "(band (bor (bnot ?x) (bnot ?y)) (bor ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("band-or-notand-to-xor-right"; "(band (bor ?x ?y) (bnot (band ?x ?y)))" => "(bxor ?x ?y)"),
        rewrite!("band-or-notand-to-xor-left"; "(band (bnot (band ?x ?y)) (bor ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("band-maxterms-to-xnor-right"; "(band (bor ?x (bnot ?y)) (bor (bnot ?x) ?y))" => "(bnot (bxor ?x ?y))"),
        ...
        rewrite!(
            "bnot-bor-not-left";
            "(bnot (bor (bnot ?x) ?y))" => "(band ?x (bnot ?y))"
        ),
        ...
        rewrite!(
            "bor-absorb-nested-and";
            "(bor ?x (band ?y (bor ?x ?z)))" => "(bor ?x (band ?y ?z))"
        ),
        rewrite!(
            "bor-absorb-nested-and-comm";
            "(bor ?x (band ?y (bor ?z ?x)))" => "(bor ?x (band ?y ?z))"
        ),
        rewrite!(
            "bor-absorb-nested-complement-and";
            "(bor ?x (band ?y (bor (bnot ?x) ?z)))" => "(bor ?x ?y)"
        ),
        rewrite!(
            "bor-absorb-nested-complement-and-comm";
            "(bor ?x (band ?y (bor ?z (bnot ?x))))" => "(bor ?x ?y)"
        ),
        rewrite!(
            "bor-absorb-nested-complement-and-invert";
            "(bor (bnot ?x) (band ?y (bor ?x ?z)))" => "(bor (bnot ?x) ?y)"
        ),
        rewrite!("bor-or-and-absorb-right"; "(bor (bor ?x ?y) (band ?x ?y))" => "(bor ?x ?y)"),
        rewrite!("bor-or-and-absorb-left"; "(bor (band ?x ?y) (bor ?x ?y))" => "(bor ?x ?y)"),
        ...
        rewrite!("bor-not-and-bnot-right"; "(bor (bnot ?x) (bnot (band ?x ?y)))" => "(bnot (band ?x ?y))"),
        rewrite!("bor-not-and-bnot-left"; "(bor (bnot (band ?x ?y)) (bnot ?x))" => "(bnot (band ?x ?y))"),
        ...
        rewrite!("bor-not-or-bnot-left"; "(bor (bnot (bor ?x ?y)) (bnot ?x))" => "(bnot ?x)"),
        ...
        rewrite!(
            "bor-consensus-term-right";
            "(bor (bor (band ?x ?y) (band (bnot ?x) ?z)) (band ?y ?z))" =>
                "(bor (band ?x ?y) (band (bnot ?x) ?z))"
        ),
        rewrite!(
            "bor-consensus-term-left";
            "(bor (band ?y ?z) (bor (band ?x ?y) (band (bnot ?x) ?z)))" =>
                "(bor (band ?x ?y) (band (bnot ?x) ?z))"
        ),
        ...
        rewrite!("bor-bxor-not-self-right"; "(bor (bnot ?x) (bxor ?x ?y))" => "(bnot (band ?x ?y))"),
        rewrite!("bor-bxor-not-self-left"; "(bor (bxor ?x ?y) (bnot ?x))" => "(bnot (band ?x ?y))"),
        rewrite!("bor-bxor-not-left-right"; "(bor ?x (bxor (bnot ?x) ?y))" => "(bor ?x (bnot ?y))"),
        rewrite!("bor-bxor-not-left-left"; "(bor (bxor (bnot ?x) ?y) ?x)" => "(bor ?x (bnot ?y))"),
        rewrite!("bxor-not-and-left"; "(bxor (bnot ?x) (band ?x ?y))" => "(bor (bnot ?x) ?y)"),
        rewrite!("bxor-not-and-right"; "(bxor (band ?x ?y) (bnot ?x))" => "(bor (bnot ?x) ?y)"),
        rewrite!("bxor-not-and-bnot-left"; "(bxor (bnot ?x) (band (bnot ?x) ?y))" => "(bnot (bor ?x ?y))"),
        rewrite!("bxor-not-and-bnot-right"; "(bxor (band (bnot ?x) ?y) (bnot ?x))" => "(bnot (bor ?x ?y))"),
        ...
        rewrite!("bor-band-notor-left"; "(bor (bnot (bor ?x ?y)) (band ?x ?y))" => "(bnot (bxor ?x ?y))"),
        rewrite!("bor-xor-notand-absorb-right"; "(bor (bxor ?x ?y) (bnot (band ?x ?y)))" => "(bnot (band ?x ?y))"),
        rewrite!("bor-xor-notand-absorb-left"; "(bor (bnot (band ?x ?y)) (bxor ?x ?y))" => "(bnot (band ?x ?y))"),
        rewrite!("bor-xor-nor-to-nand-right"; "(bor (bxor ?x ?y) (bnot (bor ?x ?y)))" => "(bnot (band ?x ?y))"),
        rewrite!("bor-xor-nor-to-nand-left"; "(bor (bnot (bor ?x ?y)) (bxor ?x ?y))" => "(bnot (band ?x ?y))"),
        ...
        rewrite!("bor-xnor-nor-absorb-right"; "(bor (bnot (bxor ?x ?y)) (bnot (bor ?x ?y)))" => "(bnot (bxor ?x ?y))"),
        rewrite!("bor-xnor-nor-absorb-left"; "(bor (bnot (bor ?x ?y)) (bnot (bxor ?x ?y)))" => "(bnot (bxor ?x ?y))"),
        ...
        rewrite!("band-bxor-not-left-right"; "(band ?x (bxor (bnot ?x) ?y))" => "(band ?x ?y)"),
        rewrite!("band-bxor-not-left-left"; "(band (bxor (bnot ?x) ?y) ?x)" => "(band ?x ?y)"),
        rewrite!("band-bxor-not-y-right"; "(band (bxor ?x ?y) (bnot ?y))" => "(band ?x (bnot ?y))"),
        rewrite!("band-bxor-not-y-left"; "(band (bnot ?y) (bxor ?x ?y))" => "(band ?x (bnot ?y))"),
        rewrite!("band-bxor-y-right"; "(band (bxor ?x ?y) ?y)" => "(band (bnot ?x) ?y)"),
        rewrite!("band-bxor-y-left"; "(band ?y (bxor ?x ?y))" => "(band (bnot ?x) ?y)"),
        rewrite!("band-xor-or-to-xor-right"; "(band (bxor ?x ?y) (bor ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("band-xor-or-to-xor-left"; "(band (bor ?x ?y) (bxor ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("band-xor-notand-absorb-right"; "(band (bxor ?x ?y) (bnot (band ?x ?y)))" => "(bxor ?x ?y)"),
        rewrite!("band-xor-notand-absorb-left"; "(band (bnot (band ?x ?y)) (bxor ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("band-xnor-or-to-and-right"; "(band (bnot (bxor ?x ?y)) (bor ?x ?y))" => "(band ?x ?y)"),
        rewrite!("band-xnor-or-to-and-left"; "(band (bor ?x ?y) (bnot (bxor ?x ?y)))" => "(band ?x ?y)"),
        rewrite!("band-xnor-and-absorb-right"; "(band (bnot (bxor ?x ?y)) (band ?x ?y))" => "(band ?x ?y)"),
        ...
        rewrite!("band-xnor-with-not-y"; "(band (bnot ?y) (bnot (bxor ?x ?y)))" => "(band (bnot ?x) (bnot ?y))"),
        rewrite!("bor-xnor-with-x"; "(bor ?x (bnot (bxor ?x ?y)))" => "(bor ?x (bnot ?y))"),
        rewrite!("bor-xnor-with-y"; "(bor ?y (bnot (bxor ?x ?y)))" => "(bor ?y (bnot ?x))"),
        rewrite!("bor-xnor-with-not-x"; "(bor (bnot ?x) (bnot (bxor ?x ?y)))" => "(bor (bnot ?x) ?y)"),
        rewrite!("bor-xnor-with-not-y"; "(bor (bnot ?y) (bnot (bxor ?x ?y)))" => "(bor (bnot ?y) ?x)"),
        ...
        rewrite!("bxor-not-or-self-right"; "(bxor ?x (bnot (bor ?x ?y)))" => "(bor ?x (bnot ?y))"),
        rewrite!("bxor-not-or-self-left"; "(bxor (bnot (bor ?x ?y)) ?x)" => "(bor ?x (bnot ?y))"),
        rewrite!("bxor-not-or-bnot-right"; "(bxor (bnot ?x) (bnot (bor ?x ?y)))" => "(band (bnot ?x) ?y)"),
        rewrite!("bxor-not-or-bnot-left"; "(bxor (bnot (bor ?x ?y)) (bnot ?x))" => "(band (bnot ?x) ?y)"),
        rewrite!("bxor-not-and-bnot-band-right"; "(bxor (bnot ?x) (bnot (band ?x ?y)))" => "(band ?x (bnot ?y))"),
        rewrite!("bxor-not-and-bnot-band-left"; "(bxor (bnot (band ?x ?y)) (bnot ?x))" => "(band ?x (bnot ?y))"),
        ...
        rewrite!("bxor-or-and-to-xor-right"; "(bxor (bor ?x ?y) (band ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("bxor-or-and-to-xor-left"; "(bxor (band ?x ?y) (bor ?x ?y))" => "(bxor ?x ?y)"),
        rewrite!("bxor-or-notand-to-xnor-right"; "(bxor (bor ?x ?y) (bnot (band ?x ?y)))" => "(bnot (bxor ?x ?y))"),
        rewrite!("bxor-or-notand-to-xnor-left"; "(bxor (bnot (band ?x ?y)) (bor ?x ?y))" => "(bnot (bxor ?x ?y))"),
        rewrite!("bxor-xor-or-to-and-right"; "(bxor (bxor ?x ?y) (bor ?x ?y))" => "(band ?x ?y)"),
        rewrite!("bxor-xor-or-to-and-left"; "(bxor (bor ?x ?y) (bxor ?x ?y))" => "(band ?x ?y)"),
        rewrite!("bxor-xor-and-to-or-right"; "(bxor (bxor ?x ?y) (band ?x ?y))" => "(bor ?x ?y)"),
        rewrite!("bxor-xor-and-to-or-left"; "(bxor (band ?x ?y) (bxor ?x ?y))" => "(bor ?x ?y)"),
        rewrite!("bxor-or-notor-to-xnor-right"; "(bxor (bor ?x ?y) (bor (bnot ?x) (bnot ?y)))" => "(bnot (bxor ?x ?y))"),
        rewrite!("bxor-or-notor-to-xnor-left"; "(bxor (bor (bnot ?x) (bnot ?y)) (bor ?x ?y))" => "(bnot (bxor ?x ?y))"),
        rewrite!("bxor-cancel-nested-right"; "(bxor ?x (bxor ?x ?y))" => "?y"),
        rewrite!("bxor-cancel-nested-left"; "(bxor (bxor ?x ?y) ?x)" => "?y"),
        rewrite!("bxor-not-self-inner-right"; "(bxor (bnot ?x) (bxor ?x ?y))" => "(bnot ?y)"),
        ...
        rewrite!("bxor-not-self-or-bnot-right"; "(bxor (bnot ?x) (bor (bnot ?x) ?y))" => "(band ?x ?y)"),
        rewrite!("bxor-not-self-or-bnot-left"; "(bxor (bor (bnot ?x) ?y) (bnot ?x))" => "(band ?x ?y)"),
        ...
        rewrite!(
            "band-consensus-term-right";
            "(band (band (bor ?x ?y) (bor (bnot ?x) ?z)) (bor ?y ?z))" =>
                "(band (bor ?x ?y) (bor (bnot ?x) ?z))"
        ),
        rewrite!(
            "band-consensus-term-left";
            "(band (bor ?y ?z) (band (bor ?x ?y) (bor (bnot ?x) ?z)))" =>
                "(band (bor ?x ?y) (bor (bnot ?x) ?z))"
        ),
        ...
        rewrite!("bxor-band-or-notx-right"; "(bxor (band ?x ?y) (bor (bnot ?x) ?y))" => "(bnot ?x)"),
        rewrite!("bxor-band-or-notx-left"; "(bxor (band ?x ?y) (bor ?y (bnot ?x)))" => "(bnot ?x)"),
        rewrite!("bxor-band-or-noty-right"; "(bxor (band ?x ?y) (bor ?x (bnot ?y)))" => "(bnot ?y)"),
        rewrite!("bxor-band-or-noty-left"; "(bxor (band ?x ?y) (bor (bnot ?y) ?x))" => "(bnot ?y)"),
        ...
        rewrite!("eq-add-self-zero"; "(eq (+ ?x ?y) ?x)" => {
            CmpZero { target: var("?y"), eq: true }
        }),
        rewrite!("ne-add-self-zero"; "(ne (+ ?x ?y) ?x)" => {
            CmpZero { target: var("?y"), eq: false }
        }),
        rewrite!("eq-sub-self-zero"; "(eq (- ?x ?y) ?x)" => {
            CmpZero { target: var("?y"), eq: true }
        }),
        rewrite!("ne-sub-self-zero"; "(ne (- ?x ?y) ?x)" => {
            CmpZero { target: var("?y"), eq: false }
        }),
        ...
        rewrite!("eq-bxor-not-x"; "(eq (bxor ?x ?y) (bnot ?x))" => {
            CmpXorAllOnes { target: var("?y"), eq: true }
        }),
        ...
        rewrite!("eq-sub-neg-right-zero"; "(eq (- ?x ?y) (neg ?y))" => {
            CmpZero { target: var("?x"), eq: true }
        }),
        rewrite!("ne-sub-neg-right-zero"; "(ne (- ?x ?y) (neg ?y))" => {
            CmpZero { target: var("?x"), eq: false }
        }),
        rewrite!("eq-sub-neg-left"; "(eq (- ?x ?y) (neg ?x))" => "(eq ?y (+ ?x ?x))"),
        rewrite!("ne-sub-neg-left"; "(ne (- ?x ?y) (neg ?x))" => "(ne ?y (+ ?x ?x))"),
        ...
        rewrite!("eq-add-const"; "(eq (+ ?x ?c1) ?c2)" => {
            CmpAddConst { x: var("?x"), c1: var("?c1"), c2: var("?c2"), eq: true }
        }),
        rewrite!("ne-add-const"; "(ne (+ ?x ?c1) ?c2)" => {
            CmpAddConst { x: var("?x"), c1: var("?c1"), c2: var("?c2"), eq: false }
        }),
        rewrite!("eq-add-move-const"; "(eq (+ ?x ?c) ?y)" => {
            CmpAddMoveConst { x: var("?x"), c: var("?c"), y: var("?y"), eq: true }
        }),
        rewrite!("ne-add-move-const"; "(ne (+ ?x ?c) ?y)" => {
            CmpAddMoveConst { x: var("?x"), c: var("?c"), y: var("?y"), eq: false }
        }),
        rewrite!("eq-add-move"; "(eq (+ ?x ?y) ?z)" => "(eq ?x (- ?z ?y))"),
        rewrite!("ne-add-move"; "(ne (+ ?x ?y) ?z)" => "(ne ?x (- ?z ?y))"),
        ...
        rewrite!("eq-sub-move"; "(eq (- ?x ?y) ?z)" => "(eq ?x (+ ?z ?y))"),
        rewrite!("ne-sub-move"; "(ne (- ?x ?y) ?z)" => "(ne ?x (+ ?z ?y))"),
        ...
        rewrite!("ne-sub-const-left"; "(ne (- ?c1 ?x) ?c2)" => {
            CmpSubConstLeft { x: var("?x"), c1: var("?c1"), c2: var("?c2"), eq: false }
        }),
        rewrite!("eq-sub-move-const-left"; "(eq (- ?c ?x) ?y)" => {
            CmpSubMoveConstLeft { x: var("?x"), c: var("?c"), y: var("?y"), eq: true }
        }),
        rewrite!("ne-sub-move-const-left"; "(ne (- ?c ?x) ?y)" => {
            CmpSubMoveConstLeft { x: var("?x"), c: var("?c"), y: var("?y"), eq: false }
        }),
        ...
        rewrite!("sle-min-left"; "(sle ?c ?x)" => { BoolConst { value: true } } if is_const_signed_min(var("?c"))),
        ...
        rewrite!("sle-max-minus-one-right"; "(sle ?x ?c)" => {
            CmpConstOffset { x: var("?x"), c: var("?c"), offset: 1, eq: false }
        ...
        rewrite!("sge-max-right"; "(sge ?x ?c)" => "(eq ?x ?c)" if is_const_signed_max(var("?c"))),
        rewrite!("sge-max-left"; "(sge ?c ?x)" => { BoolConst { value: true } } if is_const_signed_max(var("?c"))),
        ...
        rewrite!(
            "lognot-logand-not-right";
            "(lnot (land ?x (lnot ?y)))" => "(lor (lnot ?x) ?y)"
        ),
        rewrite!(
            "lognot-logand-not-left";
            "(lnot (land (lnot ?x) ?y))" => "(lor ?x (lnot ?y))"
        ),
        rewrite!("logor-demorgan"; "(lor (lnot ?a) (lnot ?b))" => "(lnot (land ?a ?b))"),
        rewrite!("lognot-logor-demorgan"; "(lnot (lor ?a ?b))" => "(land (lnot ?a) (lnot ?b))"),
        rewrite!(
            "lognot-logor-not-right";
            "(lnot (lor ?x (lnot ?y)))" => "(land (lnot ?x) ?y)"
        ),
        rewrite!(
            "lognot-logor-not-left";
            "(lnot (lor (lnot ?x) ?y))" => "(land ?x (lnot ?y))"
        ),
        ...
        rewrite!("logeq-not-self"; "(leq ?a (lnot ?a))" => { BoolConst { value: false } }),
        ...
        rewrite!("logand-lne-absorb"; "(land ?a (lne ?a ?b))" => "(land ?a (lnot ?b))"),
        rewrite!("logand-leq-absorb-not"; "(land (lnot ?a) (leq ?a ?b))" => "(land (lnot ?a) (lnot ?b))"),
        rewrite!("logand-lne-absorb-not"; "(land (lnot ?a) (lne ?a ?b))" => "(land (lnot ?a) ?b)"),
        rewrite!("logor-leq-absorb"; "(lor ?a (leq ?a ?b))" => "(lor ?a (lnot ?b))"),
        rewrite!("logor-lne-absorb"; "(lor ?a (lne ?a ?b))" => "(lor ?a ?b)"),
        rewrite!("logor-leq-absorb-not"; "(lor (lnot ?a) (leq ?a ?b))" => "(lor (lnot ?a) ?b)"),
        rewrite!("logor-lne-absorb-not"; "(lor (lnot ?a) (lne ?a ?b))" => "(lor (lnot ?a) (lnot ?b))"),
        rewrite!("logand-leq-absorb-comm"; "(land ?a (leq ?b ?a))" => "(land ?a ?b)"),
        rewrite!("logand-lne-absorb-comm"; "(land ?a (lne ?b ?a))" => "(land ?a (lnot ?b))"),
        rewrite!("logand-leq-absorb-not-comm"; "(land (lnot ?a) (leq ?b ?a))" => "(land (lnot ?a) (lnot ?b))"),
        rewrite!("logand-lne-absorb-not-comm"; "(land (lnot ?a) (lne ?b ?a))" => "(land (lnot ?a) ?b)"),
        rewrite!("logor-leq-absorb-comm"; "(lor ?a (leq ?b ?a))" => "(lor ?a (lnot ?b))"),
        rewrite!("logor-lne-absorb-comm"; "(lor ?a (lne ?b ?a))" => "(lor ?a ?b)"),
        rewrite!("logor-leq-absorb-not-comm"; "(lor (lnot ?a) (leq ?b ?a))" => "(lor (lnot ?a) ?b)"),
        rewrite!("logor-lne-absorb-not-comm"; "(lor (lnot ?a) (lne ?b ?a))" => "(lor (lnot ?a) (lnot ?b))"),
        rewrite!("logeq-land-self"; "(leq ?a (land ?a ?b))" => "(lor (lnot ?a) ?b)"),
        ...
        rewrite!("logeq-and-or"; "(leq (land ?a ?b) (lor ?a ?b))" => "(leq ?a ?b)"),
        rewrite!("logne-and-or"; "(lne (land ?a ?b) (lor ?a ?b))" => "(lne ?a ?b)"),
        rewrite!("logeq-and-notand"; "(leq (land ?a ?b) (land (lnot ?a) (lnot ?b)))" => "(lne ?a ?b)"),
        rewrite!("logne-and-notand"; "(lne (land ?a ?b) (land (lnot ?a) (lnot ?b)))" => "(leq ?a ?b)"),
        rewrite!("logeq-or-notor"; "(leq (lor ?a ?b) (lor (lnot ?a) (lnot ?b)))" => "(lne ?a ?b)"),
        rewrite!("logne-or-notor"; "(lne (lor ?a ?b) (lor (lnot ?a) (lnot ?b)))" => "(leq ?a ?b)"),
        rewrite!("logeq-minterm-dual"; "(leq (land ?a (lnot ?b)) (land (lnot ?a) ?b))" => "(leq ?a ?b)"),
        ...
        rewrite!("logne-or-notand"; "(lne (lor ?a ?b) (land (lnot ?a) (lnot ?b)))" => { BoolConst { value: true } }),
        ...
        rewrite!("logeq-or-split-b-left"; "(leq (lor (lnot ?a) ?b) (lor ?a ?b))" => "?b"),
        rewrite!("logne-or-split-a-right"; "(lne (lor ?a ?b) (lor ?a (lnot ?b)))" => "(lnot ?a)"),
        rewrite!("logne-or-split-a-left"; "(lne (lor ?a (lnot ?b)) (lor ?a ?b))" => "(lnot ?a)"),
        rewrite!("logne-or-split-b-right"; "(lne (lor ?a ?b) (lor (lnot ?a) ?b))" => "(lnot ?b)"),
        rewrite!("logne-or-split-b-left"; "(lne (lor (lnot ?a) ?b) (lor ?a ?b))" => "(lnot ?b)"),
        ...
        rewrite!(
            "logand-absorb-nested-or-comm";
            "(land ?a (lor ?b (land ?c ?a)))" => "(land ?a (lor ?b ?c))"
        ),
        ...
        rewrite!(
            "logor-consensus-term-right";
            "(lor (lor (land ?a ?b) (land (lnot ?a) ?c)) (land ?b ?c))" =>
                "(lor (land ?a ?b) (land (lnot ?a) ?c))"
        ),
        rewrite!(
            "logor-consensus-term-left";
        ...
        rewrite!(
            "logand-absorb-nested-complement-or-invert";
            "(land (lnot ?a) (lor ?b (land ?a ?c)))" => "(land (lnot ?a) ?b)"
        ),
        ...
        rewrite!(
            "logor-absorb-nested-complement-and-invert";
            "(lor (lnot ?a) (land ?b (lor ?a ?c)))" => "(lor (lnot ?a) ?b)"
        ),
        ...
        rewrite!("select-nest-neg-left"; "(select ?c (select (lnot ?c) ?x ?y) ?z)" => "(select ?c ?y ?z)"),
        rewrite!(
            "select-nest-neg-both-right";
            "(select ?c (select (lnot ?c) ?x ?y) (select ?c ?z ?w))" => "(select ?c ?y ?w)"
        ),
        rewrite!(
            "select-nest-neg-both-left";
            "(select ?c (select ?c ?x ?y) (select (lnot ?c) ?z ?w))" => "(select ?c ?x ?z)"
        ),
        rewrite!(
            "select-nest-neg-both";
            "(select ?c (select (lnot ?c) ?x ?y) (select (lnot ?c) ?z ?w))" => "(select ?c ?y ?z)"
        ),
        rewrite!(
            "select-neg-nest-right";
            "(select (lnot ?c) ?x (select ?c ?y ?z))" => "(select ?c ?y ?x)"
        ),
        rewrite!(
...
impl Applier<SpirvLang, ()> for CmpAddMoveConst {
    fn apply_one(
        ...
        let sub = egraph.add(SpirvLang::Sub([subst[self.y], const_id]));
        let cmp = if self.eq {
...
impl Applier<SpirvLang, ()> for CmpSubMoveConstLeft {
    fn apply_one(
        ...
        let const_id = egraph.add(SpirvLang::Const(constant));
        let sub = egraph.add(SpirvLang::Sub([const_id, subst[self.y]]));
        let cmp = if self.eq {
            egraph.add(SpirvLang::Eq([subst[self.x], sub]))
        } else {
            egraph.add(SpirvLang::Ne([subst[self.x], sub]))
...
impl Applier<SpirvLang, ()> for CmpXorAllOnes {
    fn apply_one(
        ...
        let cmp = if self.eq {
            ...
            egraph.add(SpirvLang::Ne([subst[self.target], all_ones]))
        };
        egraph.union(eclass, cmp);
        vec![cmp]
    }
...
mod tests {
            ...
            matches!(
                ...
                SpirvLang::Add([lhs, rhs])
                    if is_named_symbol(egraph, *lhs, name)
                        && is_named_symbol(egraph, *rhs, name)
            )
        })
    }
    ...
    fn rewrites_eq_add_with_constants() {
        ...
        assert!(found, "expected eq to compare x against sub-folded const");
    }
    ...
    fn rewrites_eq_add_moves_const_across_comparison() {
        ...
        let Some(expected_id) = runner.egraph.lookup_expr(&expected) else {
            panic!("expected x == (y - 6) to be introduced by rewrites");
        };
        assert_eq!(runner.egraph.find(root), runner.egraph.find(expected_id));
    }
    ...
    fn rewrites_eq_sub_left_moves_const_across_comparison() {
        ...
        let Some(expected_id) = runner.egraph.lookup_expr(&expected) else {
            panic!("expected x == (10 - y) to be introduced by rewrites");
        };
        assert_eq!(runner.egraph.find(root), runner.egraph.find(expected_id));
    }
    ...
    #[test]
    fn rewrites_add_self_comparison_to_zero() {
        let expr_eq = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Add([Id::from(0), Id::from(1)]),
            SpirvLang::Eq([Id::from(2), Id::from(0)]),
        ]);
        ...
        for node in &runner.egraph[class].nodes {
            ...
            if (lhs_is_y && rhs_zero) || (rhs_is_y && lhs_zero) {
                found_eq = true;
                break;
            }
        }
        assert!(found_eq, "expected eq to compare y against zero");

        let expr_ne = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Add([Id::from(0), Id::from(1)]),
            SpirvLang::Ne([Id::from(2), Id::from(0)]),
        ]);
    ...
    #[test]
    fn rewrites_sub_self_comparison_to_zero() {
        let expr_eq = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Sub([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_sub_neg_rhs_comparison_to_zero() {
        let expr_eq = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Sub([Id::from(0), Id::from(1)]),
            SpirvLang::Neg(Id::from(1)),
            SpirvLang::Eq([Id::from(2), Id::from(3)]),
        ]);
        let runner = Runner::default().with_expr(&expr_eq).run(&rewrites());
        let root = runner.roots[0];
    ...
    #[test]
    fn rewrites_sub_neg_left_comparison_to_double_lhs() {
        let expr_eq = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Sub([Id::from(0), Id::from(1)]),
        ...
        for node in &runner.egraph[class].nodes {
            ...
            let lhs_is_y = is_named_symbol(&runner.egraph, *lhs, "y");
            let rhs_is_y = is_named_symbol(&runner.egraph, *rhs, "y");
            let lhs_is_double_x = is_double_named_symbol(&runner.egraph, *lhs, "x");
            let rhs_is_double_x = is_double_named_symbol(&runner.egraph, *rhs, "x");
            if (lhs_is_y && rhs_is_double_x) || (rhs_is_y && lhs_is_double_x) {
                found_eq = true;
                break;
            }
        }
        assert!(found_eq, "expected eq to compare y against x + x");
    ...
    #[test]
    fn rewrites_add_moves_symbol_across_comparison() {
        let expr_eq = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Symbol(Symbol::from("z")), // 2
        ...
        let expected = RecExpr::from(vec![
            ...
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Symbol(Symbol::from("z")), // 2
            SpirvLang::Sub([Id::from(2), Id::from(1)]),
            SpirvLang::Eq([Id::from(0), Id::from(3)]),
        ]);
        let Some(expected_id) = runner.egraph.lookup_expr(&expected) else {
            panic!("expected x == (z - y) to be introduced by rewrites");
        };
        assert_eq!(runner.egraph.find(root), runner.egraph.find(expected_id));
    ...
    #[test]
    fn rewrites_sub_moves_symbol_across_comparison() {
        let expr_eq = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Symbol(Symbol::from("z")), // 2
    ...
    #[test]
    fn rewrites_band_complement_absorbs_or() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
    ...
    #[test]
    fn rewrites_band_complement_nested_to_zero() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
    ...
    #[test]
    fn rewrites_band_not_or_self_to_zero() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_not_and_bnot_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(2)),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitAnd([Id::from(4), Id::from(3)]),
        ]);
        let optimized = optimize_expr(&expr);
        assert_eq!(
            optimized,
    ...
    #[test]
    fn rewrites_band_not_or_bnot_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
        ...
        for node in &runner.egraph[class].nodes {
            ...
            for inner in &runner.egraph[child_class].nodes {
                let SpirvLang::BitOr([lhs, rhs]) = inner else {
                    continue;
                };
                let lhs_is_x = is_named_symbol(&runner.egraph, *lhs, "x");
                let rhs_is_x = is_named_symbol(&runner.egraph, *rhs, "x");
    ...
    #[test]
    fn rewrites_bor_not_or_bnot_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_nested_idempotence() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_nested_idempotence_swapped() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(1), Id::from(0)]),
            SpirvLang::BitAnd([Id::from(0), Id::from(2)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
    ...
    #[test]
    fn rewrites_band_bxor_not_left_to_mask() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
        ...
        for node in &runner.egraph[class].nodes {
            ...
            let lhs_is_y = is_named_symbol(&runner.egraph, *lhs, "y");
            let rhs_is_y = is_named_symbol(&runner.egraph, *rhs, "y");
            if (lhs_is_x && rhs_is_y) || (rhs_is_x && lhs_is_y) {
                found = true;
                break;
            }
        }
    ...
    #[test]
    fn rewrites_band_bxor_not_y_to_mask() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
        ...
        assert!(found, "expected (x ^ y) & ~y to rewrite to x & ~y");
    }

    #[test]
    fn rewrites_band_bxor_y_to_mask() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_xor_or_to_xor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_xor_notand_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_xnor_or_to_and() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(2)),
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
            SpirvLang::BitAnd([Id::from(3), Id::from(4)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_band_xnor_and_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_xnor_notand_to_nor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
            ...
            SpirvLang::BitAnd([Id::from(3), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_band_xnor_nor_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_notand_nor_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_band_consensus_or_y() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitOr([Id::from(3), Id::from(1)]),
            SpirvLang::BitAnd([Id::from(2), Id::from(4)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
    ...
    #[test]
    fn rewrites_band_consensus_term_elim() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Symbol(Symbol::from("z")), // 2
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitOr([Id::from(4), Id::from(2)]),
            SpirvLang::BitAnd([Id::from(3), Id::from(5)]),
            SpirvLang::BitOr([Id::from(1), Id::from(2)]),
            SpirvLang::BitAnd([Id::from(6), Id::from(7)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let expected = RecExpr::from(vec![
        ...
        let Some(expected_id) = runner.egraph.lookup_expr(&expected) else {
            panic!("expected (x | y) & (~x | z) to be introduced by rewrites");
        };
        assert_eq!(runner.egraph.find(root), runner.egraph.find(expected_id));
    }

    #[test]
    fn rewrites_band_or_notor_to_xor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
            ...
            SpirvLang::BitNot(Id::from(1)),
            SpirvLang::BitOr([Id::from(3), Id::from(4)]),
            SpirvLang::BitAnd([Id::from(2), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_band_or_notand_to_xor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bor_bxor_not_self_to_not_and() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitOr([Id::from(3), Id::from(2)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_bor_bxor_not_left_to_or_not() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
    ...
    #[test]
    fn rewrites_bor_band_xnor_to_bnot_xor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
            ...
            SpirvLang::BitNot(Id::from(1)),
            SpirvLang::BitAnd([Id::from(3), Id::from(4)]),
            SpirvLang::BitOr([Id::from(2), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
        ...
        for node in &runner.egraph[class].nodes {
            ...
            let child_class = runner.egraph.find(*child);
            for inner in &runner.egraph[child_class].nodes {
                let SpirvLang::BitXor([lhs, rhs]) = inner else {
                    continue;
                };
                let lhs_is_x = is_named_symbol(&runner.egraph, *lhs, "x");
                let rhs_is_x = is_named_symbol(&runner.egraph, *rhs, "x");
    ...
    #[test]
    fn rewrites_bor_band_notor_to_bnot_xor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(3)),
            SpirvLang::BitOr([Id::from(2), Id::from(4)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_bxor_band_bnot_bnot_to_xnor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
            ...
            SpirvLang::BitNot(Id::from(1)),
            SpirvLang::BitAnd([Id::from(3), Id::from(4)]),
            SpirvLang::BitXor([Id::from(2), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_bor_or_and_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bor_consensus_term_elim() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::Symbol(Symbol::from("z")), // 2
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitAnd([Id::from(4), Id::from(2)]),
            SpirvLang::BitOr([Id::from(3), Id::from(5)]),
            SpirvLang::BitAnd([Id::from(1), Id::from(2)]),
            SpirvLang::BitOr([Id::from(6), Id::from(7)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let expected = RecExpr::from(vec![
    ...
    #[test]
    fn rewrites_band_maxterms_to_xnor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(1)),
            SpirvLang::BitOr([Id::from(0), Id::from(2)]),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitOr([Id::from(4), Id::from(1)]),
            SpirvLang::BitAnd([Id::from(3), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
    ...
    #[test]
    fn rewrites_bor_xor_notand_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bor_xnor_and_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bor_xnor_nor_absorbs() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bor_xor_nor_to_nand() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_not_or_self_to_or_not() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_not_and_self_to_not_or() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_or_or_notx_to_not_y() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_band_or_notx_to_not_x() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_band_or_noty_to_not_y() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_not_and_mask_to_or() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitXor([Id::from(3), Id::from(2)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_bxor_not_and_bnot_mask_to_bnot_or() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
    ...
    #[test]
    fn rewrites_bxor_not_self_or_bnot_to_and() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitOr([Id::from(2), Id::from(1)]),
            SpirvLang::BitXor([Id::from(2), Id::from(3)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
    ...
    #[test]
    fn rewrites_bxor_not_or_bnot_to_and_mask() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
            SpirvLang::BitNot(Id::from(2)),
            SpirvLang::BitNot(Id::from(0)),
            SpirvLang::BitXor([Id::from(4), Id::from(3)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let class = runner.egraph.find(root);
    ...
    #[test]
    fn rewrites_bxor_not_and_bnot_to_band_not() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitAnd([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_or_and_to_xor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_or_notand_to_xnor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_xor_or_to_and() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_xor_and_to_or() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_or_notor_to_xnor() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitOr([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_bxor_not_self_inner_to_not_other() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitNot(Id::from(0)),
    ...
    #[test]
    fn rewrites_bxor_not_self_not_inner_to_other() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::Symbol(Symbol::from("y")), // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]),
    ...
    #[test]
    fn rewrites_logeq_with_negated_self_to_false() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::LogNot(Id::from(0)),       // 1 = !x
    ...
    #[test]
    fn rewrites_logne_with_negated_self_to_true() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")), // 0
            SpirvLang::LogNot(Id::from(0)),       // 1 = !x
    ...
    fn rewrites_logical_eq_absorptions() {
        ...
        assert_simplifies("(land a (lne a b))", "(land a (lnot b))");
        assert_simplifies("(land (lnot a) (leq a b))", "(land (lnot a) (lnot b))");
        assert_simplifies("(land (lnot a) (lne a b))", "(land (lnot a) b)");
        assert_simplifies("(lor a (leq a b))", "(lor a (lnot b))");
        assert_simplifies("(lor a (lne a b))", "(lor a b)");
        assert_simplifies("(lor (lnot a) (leq a b))", "(lor (lnot a) b)");
        assert_simplifies("(lor (lnot a) (lne a b))", "(lor (lnot a) (lnot b))");
        assert_simplifies("(land a (leq b a))", "(land a b)");
        assert_simplifies("(land a (lne b a))", "(land a (lnot b))");
        assert_simplifies("(land (lnot a) (leq b a))", "(land (lnot a) (lnot b))");
        assert_simplifies("(land (lnot a) (lne b a))", "(land (lnot a) b)");
        assert_simplifies("(lor a (leq b a))", "(lor a (lnot b))");
        assert_simplifies("(lor a (lne b a))", "(lor a b)");
        assert_simplifies("(lor (lnot a) (leq b a))", "(lor (lnot a) b)");
        assert_simplifies("(lor (lnot a) (lne b a))", "(lor (lnot a) (lnot b))");
        assert_simplifies("(leq a (land a b))", "(lor (lnot a) b)");
        ...
        assert_simplifies("(leq (land a b) (lor a b))", "(leq a b)");
        assert_simplifies("(lne (land a b) (lor a b))", "(lne a b)");
        assert_simplifies("(leq (land a b) (land (lnot a) (lnot b)))", "(lne a b)");
        assert_simplifies("(lne (land a b) (land (lnot a) (lnot b)))", "(leq a b)");
        assert_simplifies("(leq (lor a b) (lor (lnot a) (lnot b)))", "(lne a b)");
        assert_simplifies("(lne (lor a b) (lor (lnot a) (lnot b)))", "(leq a b)");
        assert_simplifies("(leq (land a (lnot b)) (land (lnot a) b))", "(leq a b)");
        ...
        assert_simplifies("(lne (lor a b) (land (lnot a) (lnot b)))", "true");
    }
    ...
    fn rewrites_bitwise_xnor_absorptions() {
        ...
        assert_simplifies(
            "(band (bnot y) (bnot (bxor x y)))",
            "(band (bnot x) (bnot y))",
        );
        assert_simplifies("(bor x (bnot (bxor x y)))", "(bor x (bnot y))");
        assert_simplifies("(bor y (bnot (bxor x y)))", "(bor y (bnot x))");
        assert_simplifies("(bor (bnot x) (bnot (bxor x y)))", "(bor (bnot x) y)");
        assert_simplifies("(bor (bnot y) (bnot (bxor x y)))", "(bor (bnot y) x)");
    }
    ...
    #[test]
    fn rewrites_logeq_or_split_to_b() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")),         // 0
            SpirvLang::Symbol(Symbol::from("b")),         // 1
            SpirvLang::LogOr([Id::from(0), Id::from(1)]),  // 2
    ...
    #[test]
    fn rewrites_logne_or_split_to_not_a() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")),         // 0
            SpirvLang::Symbol(Symbol::from("b")),         // 1
            SpirvLang::LogOr([Id::from(0), Id::from(1)]),  // 2
        ...
        assert_eq!(
            optimized,
            RecExpr::from(vec![
                SpirvLang::Symbol(Symbol::from("a")),
                SpirvLang::LogNot(Id::from(0))
            ])
        );
    }
    ...
    #[test]
    fn rewrites_logne_or_split_to_not_b() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")),         // 0
            SpirvLang::Symbol(Symbol::from("b")),         // 1
            SpirvLang::LogOr([Id::from(0), Id::from(1)]),  // 2
        ...
        assert_eq!(
            optimized,
            RecExpr::from(vec![
                SpirvLang::Symbol(Symbol::from("b")),
                SpirvLang::LogNot(Id::from(0))
            ])
        );
    }
    ...
    fn rewrites_logor_split_a() {
        let expr = RecExpr::from(vec![
            ...
            SpirvLang::LogOr([Id::from(2), Id::from(4)]),
        ]);
        let optimized = optimize_expr(&expr);
        assert_eq!(
            optimized,
    ...
    #[test]
    fn rewrites_logor_split_b() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")), // 0
            SpirvLang::Symbol(Symbol::from("b")), // 1
            SpirvLang::LogAnd([Id::from(0), Id::from(1)]),
            SpirvLang::LogNot(Id::from(0)),
            SpirvLang::LogAnd([Id::from(3), Id::from(1)]),
            SpirvLang::LogOr([Id::from(2), Id::from(4)]),
        ]);
        let optimized = optimize_expr(&expr);
        assert_eq!(
    ...
    #[test]
    fn rewrites_logor_consensus_term_elim() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")), // 0
            SpirvLang::Symbol(Symbol::from("b")), // 1
            SpirvLang::Symbol(Symbol::from("c")), // 2
            SpirvLang::LogAnd([Id::from(0), Id::from(1)]),
            SpirvLang::LogNot(Id::from(0)),
            SpirvLang::LogAnd([Id::from(4), Id::from(2)]),
            SpirvLang::LogOr([Id::from(3), Id::from(5)]),
            SpirvLang::LogAnd([Id::from(1), Id::from(2)]),
            SpirvLang::LogOr([Id::from(6), Id::from(7)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let expected = RecExpr::from(vec![
    ...
    #[test]
    fn rewrites_logor_xor_to_logne() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")), // 0
            SpirvLang::Symbol(Symbol::from("b")), // 1
            SpirvLang::LogNot(Id::from(1)),
            SpirvLang::LogAnd([Id::from(0), Id::from(2)]),
            SpirvLang::LogNot(Id::from(0)),
            SpirvLang::LogAnd([Id::from(4), Id::from(1)]),
            SpirvLang::LogOr([Id::from(3), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
    ...
    #[test]
    fn rewrites_logand_consensus_b() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")), // 0
            SpirvLang::Symbol(Symbol::from("b")), // 1
            SpirvLang::LogOr([Id::from(0), Id::from(1)]),
            SpirvLang::LogNot(Id::from(0)),
            SpirvLang::LogOr([Id::from(3), Id::from(1)]),
            SpirvLang::LogAnd([Id::from(2), Id::from(4)]),
        ]);
        let optimized = optimize_expr(&expr);
        assert_eq!(
    ...
    #[test]
    fn rewrites_logand_xnor_to_logeq() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")), // 0
            SpirvLang::Symbol(Symbol::from("b")), // 1
            SpirvLang::LogNot(Id::from(1)),
            SpirvLang::LogOr([Id::from(0), Id::from(2)]),
            SpirvLang::LogNot(Id::from(0)),
            SpirvLang::LogOr([Id::from(4), Id::from(1)]),
    ...
    #[test]
    fn rewrites_logand_xor_to_logne() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("a")), // 0
            SpirvLang::Symbol(Symbol::from("b")), // 1
            SpirvLang::LogOr([Id::from(0), Id::from(1)]),
            ...
            SpirvLang::LogNot(Id::from(1)),
            SpirvLang::LogOr([Id::from(3), Id::from(4)]),
            SpirvLang::LogAnd([Id::from(2), Id::from(5)]),
        ]);
        let runner = Runner::default().with_expr(&expr).run(&rewrites());
        let root = runner.roots[0];
        let expected: RecExpr<SpirvLang> = "(lne a b)".parse().unwrap();
    ...
    #[test]
    fn rewrites_eq_bxor_to_not_x_all_ones() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")),          // 0
            SpirvLang::Symbol(Symbol::from("y")),          // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]), // 2 = x ^ y
        ...
        for node in &runner.egraph[class].nodes {
            ...
            let lhs_const = const_value(&runner.egraph, *lhs);
            let rhs_const = const_value(&runner.egraph, *rhs);
            if (lhs_is_y && rhs_const == Some(expected_const))
                || (rhs_is_y && lhs_const == Some(expected_const))
            {
                found = true;
                break;
            }
        }
        assert!(found, "expected eq(y, all_ones) from x^y == ~x");
    }

    #[test]
    fn rewrites_ne_bxor_to_not_x_all_ones() {
        let expr = RecExpr::from(vec![
            SpirvLang::Symbol(Symbol::from("x")),          // 0
            SpirvLang::Symbol(Symbol::from("y")),          // 1
            SpirvLang::BitXor([Id::from(0), Id::from(1)]), // 2 = x ^ y
    ...
    fn rewrites_unsigned_compare_zero_bounds() {
        ...
        assert_simplifies("(ult 4294967295 x)", "false");
        assert_simplifies("(ule x 0)", "(eq x 0)");
        assert_simplifies("(ule 0 x)", "true");
        assert_simplifies("(ule x 4294967295)", "true");
        ...
        assert_simplifies("(ugt 4294967295 x)", "(ne x 4294967295)");
        assert_simplifies("(uge x 0)", "true");
    ...
    fn rewrites_signed_compare_extremes() {
        ...
        assert_simplifies("(slt 2147483648 x)", "(ne x 2147483648)");
        assert_simplifies("(slt x 2147483647)", "(ne x 2147483647)");
        assert_simplifies("(slt 2147483647 x)", "false");
        assert_simplifies("(sle x 2147483648)", "(eq x 2147483648)");
        assert_simplifies("(sle 2147483648 x)", "true");
        ...
        assert_simplifies("(sgt x 2147483647)", "false");
        assert_simplifies("(sgt 2147483647 x)", "(ne x 2147483647)");
        assert_simplifies("(sge x 2147483648)", "true");
    ...
    #[test]
    fn rewrites_bnot_bor_not_left() {
        assert_simplifies("(bnot (bor (bnot x) y))", "(band x (bnot y))");
    }

    #[test]
    fn rewrites_band_commutes() {
        assert_simplifies("(band x y)", "(band y x)");
    }
    ...
    #[test]
    fn rewrites_bor_shl_factor() {
        assert_simplifies("(bor (shl x c) (shl y c))", "(shl (bor x y) c)");
    }

    #[test]
    fn rewrites_bxor_shl_factor() {
        assert_simplifies("(bxor (shl x c) (shl y c))", "(shl (bxor x y) c)");
    }

    #[test]
    fn rewrites_band_shru_factor() {
        assert_simplifies("(band (shr_u x c) (shr_u y c))", "(shr_u (band x y) c)");
    }

    #[test]
    fn rewrites_bor_shru_factor() {
        assert_simplifies("(bor (shr_u x c) (shr_u y c))", "(shr_u (bor x y) c)");
    }
    ...
    #[test]
    fn rewrites_bor_shrs_factor() {
        assert_simplifies("(bor (shr_s x c) (shr_s y c))", "(shr_s (bor x y) c)");
    }
    ...
    #[test]
    fn rewrites_lognot_logand_not_right() {
        assert_simplifies("(lnot (land a (lnot b)))", "(lor (lnot a) b)");
    }

    #[test]
    fn rewrites_lognot_logand_not_left() {
        assert_simplifies("(lnot (land (lnot a) b))", "(lor a (lnot b))");
    }

    #[test]
    fn rewrites_lognot_logor_not_right() {
        assert_simplifies("(lnot (lor a (lnot b)))", "(land (lnot a) b)");
    }

    #[test]
    fn rewrites_lognot_logor_not_left() {
        assert_simplifies("(lnot (lor (lnot a) b))", "(land a (lnot b))");
    }

    #[test]
    fn rewrites_logor_associates() {
        assert_simplifies("(lor a (lor b c))", "(lor (lor a b) c)");
    }
    ...
    #[test]
    fn rewrites_band_brev_factor() {
        assert_simplifies("(band (brev x) (brev y))", "(brev (band x y))");
    }
    ...
    #[test]
    fn rewrites_select_nested_negated_left() {
        assert_simplifies("(select c (select (lnot c) x y) z)", "(select c y z)");
    }

    #[test]
    fn rewrites_select_nested_negated_both_right() {
        assert_simplifies(
            "(select c (select (lnot c) x y) (select c z w))",
            "(select c y w)",
        );
    }

    #[test]
    fn rewrites_select_nested_negated_both_left() {
        assert_simplifies(
            "(select c (select c x y) (select (lnot c) z w))",
            "(select c x z)",
        );
    }

    #[test]
    fn rewrites_select_nested_negated_both() {
        assert_simplifies(
            "(select c (select (lnot c) x y) (select (lnot c) z w))",
            "(select c y z)",
        );
    }

    #[test]
    fn rewrites_select_negated_outer_with_nested_else() {
        assert_simplifies("(select (lnot c) x (select c y z))", "(select c y x)");
    }
